...
function injectStyles() {
  ...
  style.textContent = `
    .hosp-tabs{display:flex;gap:10px;flex-wrap:wrap;margin:16px 0}.hosp-tab{width:auto;margin-top:0;border:1px solid var(--line-2);background:#0b1220;color:var(--text);border-radius:999px;padding:10px 14px;cursor:pointer;font-weight:800}.hosp-tab.active{background:rgba(22,101,52,.32);color:#dcfce7;border-color:rgba(111,208,165,.34)}
    .hosp-panel{display:none}.hosp-panel.active{display:block}.hosp-form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.hosp-field{display:flex;flex-direction:column;gap:7px}.hosp-field.full{grid-column:1/-1}.hosp-field label{font-size:13px;color:#cbd5e1;font-weight:800}.hosp-field input,.hosp-field textarea,.hosp-field select{width:100%;border:1px solid #334155;background:#0b1220;color:var(--text);border-radius:14px;padding:12px 13px;outline:none;color-scheme:dark}.hosp-field textarea{resize:vertical;min-height:86px}.hosp-field input:focus,.hosp-field textarea:focus,.hosp-field select:focus{border-color:var(--green-2);box-shadow:0 0 0 3px rgba(111,208,165,.12)}.hosp-help{font-size:12px;color:var(--muted)}
    .hosp-actions{display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-top:16px}.hosp-btn{width:auto!important;margin-top:0!important}.hosp-feedback{color:var(--muted);font-size:13px}.hosp-feedback.ok{color:#bbf7d0}.hosp-feedback.err{color:#fecaca}.hosp-table-wrap{overflow:auto;border:1px solid var(--line);border-radius:18px}.hosp-table{width:100%;border-collapse:collapse;min-width:1040px;background:#0b1220}.hosp-table th,.hosp-table td{padding:12px 14px;border-bottom:1px solid var(--line);text-align:left;vertical-align:top}.hosp-table th{font-size:12px;color:var(--muted);text-transform:uppercase;letter-spacing:.07em}.hosp-table tr:hover td{background:rgba(111,208,165,.035)}
    ...
    .hosp-mini-list{display:grid;gap:10px}.hosp-mini-item{border:1px solid var(--line);border-radius:16px;padding:12px;background:#0b1220}.hosp-mini-item strong{display:block}.hosp-mini-item span{color:var(--muted);font-size:13px}.hosp-summary{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:10px;margin-top:12px}.hosp-summary div{border:1px solid var(--line);border-radius:16px;padding:12px;background:rgba(11,18,32,.8)}.hosp-summary strong{display:block;font-size:20px;color:#dcfce7}.hosp-summary span{display:block;color:var(--muted);font-size:12px;margin-top:4px}.hosp-colab-box{display:grid;gap:10px}.hosp-colab-row{display:grid;grid-template-columns:1.2fr .6fr auto;gap:10px;align-items:end}.hosp-remove{width:auto!important;margin-top:0!important;padding:10px 12px!important}.hosp-empty{padding:18px;color:var(--muted);text-align:center}.hosp-alert{border:1px solid rgba(245,158,11,.24);background:rgba(245,158,11,.08);color:#fde68a;border-radius:16px;padding:12px 14px;margin-top:12px}
