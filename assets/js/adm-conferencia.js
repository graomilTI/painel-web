...
function renderStyles() {
  return `
    <style>
      ...
      /* Sublinhado em vez de pill/card (pedido 11/09: abas não devem parecer botão próprio,
         só o item ativo ganha destaque de cor + traço embaixo) — mesmo padrão de .hosp-shell
         .ds-tab em hospedagem.js. */
      .conf-tabs{display:flex;gap:4px;flex-wrap:wrap}.conf-tab{border:0;border-radius:0;background:transparent;padding:10px 12px 8px;color:#a9b8b1;font-weight:800;cursor:pointer;border-bottom:2px solid transparent}.conf-tab:hover{color:#d9fbe8;background:rgba(34,197,94,.035)}.conf-tab.active{background:transparent;border-bottom-color:#22e58a;color:#35e990}
