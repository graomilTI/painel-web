(function () {
  ...
  function styles() {
    return `<style>
      .ex-wrap{padding:16px;color:#e5e7eb;font-family:Arial,sans-serif}
      .ex-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px}
      .ex-card{background:#0f172a;border:1px solid #1e293b;border-radius:18px;padding:16px}
      ...
      .ex-table th,.ex-table td{padding:8px;border-bottom:1px solid #1e293b;text-align:left}
    </style>`;
  }
