(function () {
  const MODULE_NAME = 'FROTAS_MANUTENCAO';
  const TABLE = 'frotas_manutencoes';
  ...
  const styles = `
    <style>
      .fm-shell{color:#e2e2f0}.fm-head{margin-bottom:18px}.fm-kicker{color:#86efac;text-transform:uppercase;letter-spacing:.14em;font-weight:950;font-size:12px}.fm-title{margin:8px 0 6px;font-size:clamp(24px,2.4vw,34px);letter-spacing:-.04em;color:#f8fafc}.fm-sub{max-width:900px;color:#6b7280;line-height:1.55;margin:0}.fm-card{border:1px solid rgba(148,163,184,.16);border-radius:24px;background:radial-gradient(circle at top left,rgba(34,197,94,.13),transparent 34%),linear-gradient(180deg,rgba(15,23,42,.98),rgba(2,6,23,.98));box-shadow:0 20px 60px rgba(0,0,0,.28);overflow:hidden}.fm-tabs{display:flex;gap:10px;flex-wrap:wrap;padding:14px;border-bottom:1px solid rgba(148,163,184,.12);background:rgba(2,6,23,.36)}.fm-tab{border:1px solid rgba(148,163,184,.18);background:rgba(15,23,42,.72);color:#cbd5e1;border-radius:999px;padding:10px 14px;font-weight:950;cursor:pointer}.fm-tab.active,.fm-tab:hover{border-color:rgba(34,197,94,.55);background:rgba(22,101,52,.35);color:#f8fafc}.fm-body{padding:18px}.fm-toolbar{display:grid;grid-template-columns:minmax(220px,1fr) auto auto;gap:10px;margin-bottom:14px}.fm-input,.fm-select{width:100%;height:42px;border:1px solid rgba(148,163,184,.18);border-radius:14px;background:#0d0d18;color:#e2e2f0;padding:0 12px;outline:none;color-scheme:dark}.fm-select option{background:#0d0d18;color:#e2e2f0}.fm-btn{border:0;border-radius:14px;min-height:42px;padding:0 14px;font-weight:950;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;gap:8px}.fm-btn.primary{background:linear-gradient(135deg,#16a34a,#22c55e);color:#052e16}.fm-btn.soft{border:1px solid rgba(34,197,94,.24);background:rgba(34,197,94,.12);color:#86efac}.fm-btn.ghost{border:1px solid rgba(148,163,184,.18);background:rgba(15,23,42,.72);color:#cbd5e1}.fm-btn.done{background:rgba(34,197,94,.16);color:#86efac;border:1px solid rgba(34,197,94,.3)}.fm-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:14px 0}.fm-kpi{border:1px solid rgba(34,197,94,.18);background:rgba(2,6,23,.32);border-radius:14px;padding:12px 14px;min-width:0}.fm-kpi span{display:block;color:#93c5fd;font-size:10px;font-weight:950;letter-spacing:.08em;text-transform:uppercase;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.fm-kpi strong{display:block;margin-top:7px;color:#fff;font-size:22px;line-height:1}.fm-table-wrap{overflow:auto;border:1px solid rgba(148,163,184,.14);border-radius:18px}.fm-table{width:100%;border-collapse:collapse;min-width:1100px}.fm-table th{padding:12px 11px;color:#bfdbfe;font-size:11px;letter-spacing:.1em;text-transform:uppercase;text-align:left;border-bottom:1px solid rgba(148,163,184,.16);background:rgba(2,6,23,.38)}.fm-table td{padding:12px 11px;border-bottom:1px solid rgba(148,163,184,.10);color:#e2e2f0;font-size:13px;vertical-align:top}.fm-table tr:hover td{background:rgba(22,101,52,.08)}.fm-badge{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:4px 8px;font-size:10px;font-weight:950;border:1px solid rgba(148,163,184,.18);color:#cbd5e1;background:rgba(15,23,42,.72);white-space:nowrap}.fm-badge.ok{border-color:rgba(34,197,94,.35);background:rgba(22,101,52,.24);color:#bbf7d0}.fm-badge.warn{border-color:rgba(245,158,11,.34);background:rgba(245,158,11,.12);color:#fde68a}.fm-badge.err{border-color:rgba(239,68,68,.34);background:rgba(239,68,68,.12);color:#fecaca}.fm-mini{min-height:32px;border-radius:10px;padding:0 10px;font-size:11px}.fm-form{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin:0 0 16px;padding:14px;border:1px solid rgba(34,197,94,.18);background:rgba(2,6,23,.32);border-radius:18px}.fm-field label{display:block;margin:0 0 6px;color:#bbf7d0;font-size:11px;font-weight:950;text-transform:uppercase;letter-spacing:.08em}.fm-field.full{grid-column:1/-1}.fm-field textarea{width:100%;min-height:68px;resize:vertical;border:1px solid rgba(148,163,184,.18);border-radius:14px;background:#0d0d18;color:#e2e2f0;padding:12px;outline:none}.fm-note{margin-top:12px;padding:12px 14px;border:1px dashed rgba(34,197,94,.28);border-radius:16px;background:rgba(2,6,23,.26);color:#bfdbfe;font-size:12px;line-height:1.5}.fm-empty{text-align:center;color:#f8fafc;padding:26px!important;font-weight:850}.fm-toast{position:fixed;right:22px;bottom:22px;z-index:9999;border:1px solid rgba(134,239,172,.32);background:rgba(22,101,52,.96);color:#dcfce7;border-radius:16px;padding:12px 14px;font-weight:950;box-shadow:0 16px 45px rgba(0,0,0,.35);opacity:0;transform:translateY(10px);pointer-events:none;transition:.2s ease}.fm-toast.show{opacity:1;transform:translateY(0)}@media(max-width:1200px){.fm-toolbar{grid-template-columns:1fr 1fr}.fm-grid{grid-template-columns:repeat(2,1fr)}.fm-form{grid-template-columns:repeat(2,1fr)}}@media(max-width:680px){.fm-toolbar,.fm-grid,.fm-form{grid-template-columns:1fr}}
    </style>`;
  ...
  function setFormOpen(root, open){
    ...
    if(toggleBtn) toggleBtn.textContent = open ? '✕ Fechar cadastro' : '+ Nova manutenção';
  }
  ...
  function getFiltered(){
    ...
    return state.registros.filter(r => norm([r.__placa, r.tipo_servico, r.oficina, r.descricao].join(' ')).includes(busca));
  }
  ...
  async function loadRegistros(root, opts){
    ...
    if(error){ toast(error.message || 'Erro ao carregar manutenções.', true); state.registros = []; }
    else {
  ...
  function readForm(root){
    ...
    return {
      ...
      tipo_servico: get('tipo_servico').trim() || null,
      oficina: get('oficina').trim() || null,
  ...
  function fillForm(root, r){
    ...
    set('veiculo_id', r?.veiculo_id); set('tipo_servico', r?.tipo_servico); set('oficina', r?.oficina);
    ...
    set('proxima_km', r?.proxima_km); set('descricao', r?.descricao); set('observacoes', r?.observacoes);
  ...
  async function uploadAnexo(opts, file, veiculoId){
    if(!file) return null;
    const path = `frotas-manutencao/${veiculoId}/${Date.now()}-${file.name}`;
  ...
  async function saveRegistro(root, opts){
    ...
    try {
      ...
      if(error) throw error;
      toast(state.editId ? 'Manutenção atualizada.' : 'Manutenção registrada.');
      resetForm(root);
      await loadRegistros(root, opts);
    } catch(err){
      toast(err.message || 'Erro ao salvar manutenção.', true);
    }
  }
  ...
  function renderTable(root, opts){
    ...
    if(state.loading){ tbody.innerHTML = '<tr><td colspan="8" class="fm-empty">Carregando manutenções...</td></tr>'; return; }
    const rows = getFiltered();
    root.querySelector('[data-count]').textContent = `${rows.length} registro(s) encontrado(s)`;
    if(!rows.length){ tbody.innerHTML = '<tr><td colspan="8" class="fm-empty">Nenhuma manutenção registrada.</td></tr>'; return; }
    tbody.innerHTML = rows.map(r => `
      <tr>
        <td><strong>${esc(r.__placa || '—')}</strong></td>
        <td>${esc(r.tipo_servico || '—')}<br><small>${esc(r.oficina || '')}</small></td>
        ...
        <td>${r.anexo_url ? `<a href="${esc(r.anexo_url)}" target="_blank" rel="noopener" style="color:#86efac">Ver anexo</a>` : '—'}</td>
  ...
  function openHome(container, opts = {}){
    container.innerHTML = `${styles}<section class="fm-shell"><div class="fm-head"><div class="fm-kicker">Frotas · Manutenção</div><h1 class="fm-title">Manutenção</h1><p class="fm-sub">Registro de manutenções por veículo (serviço, oficina, custo e anexo da nota fiscal), com aviso de próxima manutenção por data ou km.</p></div><div class="fm-card"><div class="fm-tabs"><button class="fm-tab" type="button" data-open-dashboard>Dashboard</button><button class="fm-tab" type="button" data-open-veiculos>Veículos</button><button class="fm-tab" type="button" data-open-motoristas>Motoristas</button><button class="fm-tab" type="button" data-open-multas>Multas</button><button class="fm-tab active" type="button">Manutenção</button><button class="fm-tab" type="button" data-open-troca-oleo>Troca de Óleo</button><button class="fm-tab" type="button" data-open-checklists>Checklists</button><button class="fm-tab" type="button" data-open-rastreadores>Rastreadores</button></div><div class="fm-body"><div class="fm-toolbar"><input class="fm-input" placeholder="Buscar por placa, serviço, oficina..." data-search><button class="fm-btn primary" type="button" data-toggle-form>+ Nova manutenção</button><button class="fm-btn soft" type="button" data-refresh>↻ Atualizar</button></div><div data-form-wrap style="display:none"><form class="fm-form" data-registro-form><div class="fm-field"><label>Veículo</label><select class="fm-select" name="veiculo_id" data-veiculo-select><option value="">Selecione...</option></select></div><div class="fm-field"><label>Tipo de serviço</label><input class="fm-input" name="tipo_servico" placeholder="Ex: Revisão, Freios, Suspensão"></div><div class="fm-field"><label>Oficina</label><input class="fm-input" name="oficina"></div><div class="fm-field"><label>Data da execução</label><input class="fm-input" name="data_execucao" type="date"></div><div class="fm-field"><label>Km na execução</label><input class="fm-input" name="km_execucao" type="number" min="0"></div><div class="fm-field"><label>Custo (R$)</label><input class="fm-input" name="custo" type="number" min="0" step="0.01"></div><div class="fm-field"><label>Próxima manutenção (data)</label><input class="fm-input" name="proxima_data" type="date"></div><div class="fm-field"><label>Próxima manutenção (km)</label><input class="fm-input" name="proxima_km" type="number" min="0"></div><div class="fm-field full"><label>Descrição</label><input class="fm-input" name="descricao" placeholder="Detalhes do serviço realizado"></div><div class="fm-field"><label>Anexo (nota fiscal)</label><input class="fm-input" name="anexo" type="file" accept=".pdf,.jpg,.jpeg,.png"></div><div class="fm-field full"><label>Observações</label><textarea name="observacoes"></textarea></div><div class="fm-field full" style="display:flex;gap:8px"><button class="fm-btn primary" type="button" data-save-registro>Salvar manutenção</button><button class="fm-btn ghost" type="button" data-cancel-edit>Cancelar edição</button></div></form></div><div class="fm-grid"><div class="fm-kpi"><span>Total</span><strong data-kpi-total>0</strong></div><div class="fm-kpi"><span>Vencidas</span><strong data-kpi-vencidas>0</strong></div><div class="fm-kpi"><span>Próximas</span><strong data-kpi-proximas>0</strong></div><div class="fm-kpi"><span>Em dia</span><strong data-kpi-emdia>0</strong></div></div><p class="fm-sub" data-count>0 registro(s) encontrado(s)</p><div class="fm-table-wrap"><table class="fm-table"><thead><tr><th>Veículo</th><th>Serviço / Oficina</th><th>Data / Km</th><th>Custo</th><th>Próxima</th><th>Situação</th><th>Anexo</th><th>Ações</th></tr></thead><tbody data-registros-table></tbody></table></div><div class="fm-note">"Vencida" aparece quando a data ou km da próxima manutenção já passou; "Próxima" avisa com ${AVISO_DIAS} dias ou ${AVISO_KM.toLocaleString('pt-BR')}km de antecedência. O km atual do veículo vem do hodômetro cadastrado em Frotas &gt; Veículos.</div></div></div></section>`;

    container.querySelector('[data-open-dashboard]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-dashboard'));
    container.querySelector('[data-open-veiculos]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-veiculos'));
    container.querySelector('[data-open-motoristas]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-motoristas'));
    container.querySelector('[data-open-multas]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-multas'));
    container.querySelector('[data-open-troca-oleo]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-troca-oleo'));
    container.querySelector('[data-open-checklists]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-checklists'));
    container.querySelector('[data-open-rastreadores]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-rastreadores'));
