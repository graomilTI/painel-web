(function () {
  ...
  function openHome(container, opts = {}){
    ...
    container.querySelector('[data-open-historico]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-historico'));
