          ...
          <div class="frotas-body">
            <div class="speed-grid">
              <div class="speed-panel">
                ...
                <div class="speed-field"><label>Colaborador / Motorista</label>${colaboradores.length ? `<select class="speed-select" data-speed-name><option value="">Selecione o colaborador</option>${colaboradores.map((c) => `<option value="${escapeHtml(c.nome)}">${escapeHtml(c.nome)}</option>`).join('')}</select>` : `<input class="speed-input" type="text" placeholder="Nome do colaborador" data-speed-name>`}</div>
                ...
                <div class="speed-actions"><button class="speed-btn speed-btn-primary" type="button" data-generate-speed-message>Gerar ✉️</button></div>
              </div>
