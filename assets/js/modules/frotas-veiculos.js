(function () {
  ...
  function openHome(container, opts={}){
    ...
    container.querySelector('[data-open-multas]')?.addEventListener('click',()=>window.location.assign('https://grao1000.com.br/painel/frotas-multas'));container.querySelector('[data-open-historico]')?.addEventListener('click',()=>window.location.assign('https://grao1000.com.br/painel/frotas-historico'));container.querySelector('[data-open-rastreadores]')?.addEventListener('click',()=>window.location.assign('https://grao1000.com.br/painel/frotas-rastreadores'));
