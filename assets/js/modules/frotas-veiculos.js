(function () {
  ...
  async function consultarMultas(root, opts, v){
    ...
    try{
      ...
      window.location.assign(toPanelRoute('frotas-multas'));
  ...
  function openHome(container, opts={}){
    ...
    container.querySelector('[data-open-excesso]')?.addEventListener('click',()=>window.location.assign(toPanelRoute('frotas')));
