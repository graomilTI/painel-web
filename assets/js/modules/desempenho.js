...
(function () {
  ...
  function injectStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      .des-page{--bg:#020617;--panel:#0f172a;--card:rgba(15,23,42,.92);--line:rgba(148,163,184,.18);--text:#e5e7eb;--muted:#94a3b8;--green:#22c55e;--green2:#166534;--red:#ef4444;--yellow:#facc15;color:var(--text);width:100%}
      ...
      .des-kicker{font-size:12px;color:#bbf7d0;font-weight:900;letter-spacing:.08em;text-transform:uppercase}.des-hero h1{margin:6px 0 4px;font-size:30px;letter-spacing:-.045em}.des-hero p{margin:0;color:var(--muted);max-width:820px;line-height:1.5}.des-actions{display:flex;gap:10px;flex-wrap:wrap;justify-content:flex-end}.des-btn,.des-field select,.des-field input{height:42px;border-radius:14px;border:1px solid #334155;background:#0f172a;color:#e5e7eb;padding:0 12px;font-weight:850;color-scheme:dark}.des-btn{cursor:pointer;background:linear-gradient(135deg,#166534,#22c55e);color:#052e16;border:0}.des-btn.secondary{background:#0f172a;color:#e5e7eb;border:1px solid #334155}.des-btn:disabled{opacity:.55;cursor:not-allowed}.des-field select option{background:#0f172a;color:#e5e7eb}.des-field select option:checked{background:#166534;color:#fff}
      ...
      .des-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-bottom:16px}.des-card{padding:16px}.des-card span{display:block;color:var(--muted);font-size:11px;font-weight:900;text-transform:uppercase;letter-spacing:.04em}.des-card strong{display:block;margin-top:8px;font-size:24px;letter-spacing:-.035em}.des-card small{display:block;margin-top:4px;color:#94a3b8}.des-status{margin-bottom:14px;padding:12px 14px;border-radius:16px;border:1px solid var(--line);background:rgba(15,23,42,.72);color:var(--muted)}.des-status strong{color:var(--text)}.des-status.err{border-color:rgba(239,68,68,.45);color:#fecaca;background:rgba(127,29,29,.22)}
      .des-table-card{overflow:hidden}.des-table-top{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:16px 18px;border-bottom:1px solid var(--line);flex-wrap:wrap}.des-table-top h2{margin:0;font-size:18px}.des-table-top p{margin:4px 0 0;color:var(--muted);font-size:12px}.des-table-wrap{overflow:auto;background:#fff}.des-table{width:100%;border-collapse:collapse;font-size:12px;min-width:980px;color:#111827}.des-table th{position:sticky;top:0;z-index:1;background:#e5e7eb;color:#111827;text-align:center;font-weight:900;padding:8px;border:1px solid #9ca3af;white-space:nowrap}.des-table th.sortable{cursor:pointer;user-select:none}.des-table th.sortable:hover{background:#bbf7d0}.des-table td{padding:7px 8px;border:1px solid #cbd5e1;text-align:right;white-space:nowrap}.des-table td:first-child{text-align:left;font-weight:900;color:#111827;min-width:240px}.des-table tr.total td{background:#f8fafc!important;font-weight:950}.des-table tr.empty td{background:#fff!important;text-align:center;color:#64748b}.des-val{font-variant-numeric:tabular-nums}.des-muted{color:#94a3b8}.des-cell-low{background:#fecaca}.des-cell-mid{background:#bbf7d0}.des-cell-high{background:#22c55e;color:#052e16;font-weight:900}.des-cell-zero{background:#fee2e2;color:#991b1b}.des-footer-note{padding:12px 16px;color:#64748b;background:#fff;border-top:1px solid #e5e7eb;font-size:12px}
