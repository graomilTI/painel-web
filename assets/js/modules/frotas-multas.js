(function(){
  ...
  const state={multas:[], motoristas:[], motoristasLoaded:false, busca:'', filtro:'pagas', arquivo:'ativas', sortKey:'vencimento', sortDir:'desc', subTab:'todas'};
