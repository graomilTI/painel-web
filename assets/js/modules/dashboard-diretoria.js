...
(function () {
  ...
  // Custo/t fica na casa de poucos reais — sem casas decimais toda linha
  // arredondava pra R$ 1, R$ 2, R$ 3..., escondendo a diferença real entre
  // coordenações.
  const fmtMoneyPreciso = (v) => n(v).toLocaleString('pt-BR',{style:'currency',currency:'BRL',minimumFractionDigits:2,maximumFractionDigits:2});
