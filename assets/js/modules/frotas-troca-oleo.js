(function () {
  ...
  function openHome(container, opts = {}){
    ...
    container.querySelector('[data-open-manutencao]')?.addEventListener('click', () => window.location.assign('https://grao1000.com.br/painel/frotas-manutencao'));
