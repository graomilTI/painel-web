...
const MODULE_GROUP_FALLBACKS = [
  ...
  { group: 'EQUIPE', terms: ['contatos e cadastros', 'contatos', 'colaboradores', 'admissao', 'admissão', 'graint', 'integracao', 'integração'] },
  { group: 'INDISPONIBILIDADE', terms: ['ferias', 'férias', 'atestados', 'indisponibilidade'] },
  { group: 'SEGURANÇA DO TRABALHO', terms: ['epi', 'cat', 'seguranca do trabalho', 'segurança do trabalho'] },
  { group: 'EXAMES', terms: ['exames', 'clinicas', 'clínicas'] },
  { group: 'CONTRATOS', terms: ['contrato de experiencia', 'contrato de experiência', 'rescisao', 'rescisão', 'rescisoes', 'rescisões'] },
  { group: 'CARTÃO PONTO', terms: ['cartao ponto', 'cartão ponto', 'ponto eletronico', 'ponto eletrônico'] },
  { group: 'ADVERTÊNCIAS', terms: ['advertencia', 'advertência'] },
  { group: 'HOLERITE E PAGAMENTOS', terms: ['holerite', 'folha de pagamento', 'folha'] },
