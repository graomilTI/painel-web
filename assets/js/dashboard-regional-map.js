...
const REGION_PATHS = {
  ...
  MT3_QUERENCIA: 'M395.89,355.98L396.75,349.11L404.31,333.60L417.81,323.65L419.56,320.23L414.09,308.06L437.94,309.65L452.92,310.65L472.80,311.99L480.99,312.53L476.27,327.18L471.54,341.88L471.03,343.45L472.27,354.23Z',
...
const LABEL_POS = {
  MT4: { x: 303.3, y: 357.4 },
  MT1: { x: 364.2, y: 340.6 },
  MT3_QUERENCIA: { x: 440, y: 331 },
  MT2: { x: 381.6, y: 424.2 },
  MT3_CONFRESA: { x: 448, y: 380 },
...
const OVERLAY_VIEWBOX = { x: -340, y: 0, w: 1480, h: 796 };
...
const ZOOM_BOX = {
  MT: { x: -340, y: 300, w: 340, h: 340 },
  PR: { x: 800, y: 480, w: 340, h: 230 },
};
