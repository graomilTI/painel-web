...
function injectStyles() {
  ...
  style.textContent = `
    ...
    .hosp-v2-row.hosp-v2-request-row{grid-template-columns:minmax(150px,.9fr) minmax(190px,1.05fr) minmax(240px,1.35fr) minmax(150px,.9fr) minmax(150px,.9fr) minmax(390px,1.9fr);min-width:1220px;border-radius:4px}.hosp-v2-request-row .hosp-v2-cell{padding:10px 12px;display:flex;align-items:center}.hosp-v2-request-row .hosp-v2-cell.actions{padding:5px}.hosp-v2-request-row .hosp-v2-city{display:flex;gap:7px;align-items:center;font-size:12px;font-weight:900;color:#effff5}.hosp-v2-request-row .hosp-v2-city svg,.hosp-v2-request-row .hosp-v2-date svg{width:14px;height:14px;fill:none;stroke:#4ade80;stroke-width:1.9;flex:0 0 auto}.hosp-v2-request-row .hosp-v2-date{display:flex;gap:7px;align-items:center;font-size:11.5px;font-weight:850;white-space:nowrap}.hosp-v2-people{display:block;color:#d8eee3;font-size:11px;font-weight:800;line-height:1.4}.hosp-v2-person{display:inline;padding:0;border:0;border-radius:0;background:transparent;color:inherit;font:inherit;text-transform:none}.hosp-v2-supervision{font-size:11px;font-weight:800;color:#c8dbd2}.hosp-v2-request-row .hosp-v2-hotel{font-size:11px}.hosp-v2-request-row .hosp-v2-actions{display:grid;grid-template-columns:repeat(6,minmax(58px,1fr));width:100%;gap:5px}.hosp-v2-request-row .hosp-v2-btn{min-height:39px;font-size:8.5px;border-radius:9px}.hosp-v2-request-row .hosp-v2-btn svg{width:15px;height:15px}
