...
function injectStyles() {
  ...
  style.textContent = `
    ...
    .hosp-v2-stage-head,.hosp-v2-stage-row{display:grid;grid-template-columns:minmax(185px,1.15fr) minmax(135px,.8fr) minmax(170px,.9fr) minmax(260px,1.5fr) minmax(120px,.7fr) minmax(190px,.9fr);min-width:1060px}.hosp-v2-stage-head{padding:0 11px;color:#91a89e;font-size:10px;font-weight:950;text-transform:uppercase;letter-spacing:.08em}.hosp-v2-stage-head span{padding:7px 10px}.hosp-v2-stage-row{position:relative;overflow:hidden;border:1px solid rgba(34,197,94,.28);border-radius:12px;background:linear-gradient(100deg,rgba(5,27,20,.98),rgba(2,16,12,.98));box-shadow:0 8px 24px rgba(0,0,0,.16);transition:.16s ease}.hosp-v2-stage-row::before{content:"";position:absolute;left:0;top:0;bottom:0;width:3px;background:#4ade80}.hosp-v2-stage-row:hover{border-color:rgba(74,222,128,.68);transform:translateY(-1px)}.hosp-v2-stage-cell{display:flex;flex-direction:column;justify-content:center;min-width:0;padding:12px 14px;border-right:1px solid rgba(74,222,128,.1);color:#d8eee3;font-size:11.5px}.hosp-v2-stage-cell:last-child{border-right:0}.hosp-v2-stage-cell strong{color:#f1fff7;font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.hosp-v2-stage-cell small{margin-top:4px;color:#88a298;font-size:10.5px}.hosp-v2-stage-cell.people{white-space:normal;line-height:1.4}.hosp-v2-stage-cell.value strong{color:#86efac;font-size:13px}.hosp-v2-stage-actions{display:grid;grid-template-columns:1fr 1fr;gap:7px}.hosp-v2-stage-actions .hosp-v2-btn{min-height:38px;flex-direction:row;font-size:9.5px}.hosp-v2-stage-actions .hosp-v2-btn svg{width:15px;height:15px}
...
function renderList(id, rows, requested = false, stage = '') {
  ...
  const operational = ['andamento','pagar'].includes(stage);
  const head = requested ? `<div class="hosp-v2-list-head">${sortHeader('cidade','Cidade')}${sortHeader('checkin','Check-in / Diárias')}${sortHeader('colaborador','Colaboradores')}${sortHeader('supervisao','Supervisão')}${sortHeader('gestor','Gestor')}<span class="hosp-v2-list-head-label">Ações</span></div>` : operational ? `<div class="hosp-v2-stage-head"><span>Hotel</span><span>Cidade</span><span>Data</span><span>Colaboradores</span><span>Valor</span><span>Ações</span></div>` : '';
...
function operationalRowHtml(row,stage) {
  ...
  return `<article class="hosp-v2-stage-row">
    <div class="hosp-v2-stage-cell"><strong title="${esc(hotel)}">${esc(hotel)}</strong></div>
