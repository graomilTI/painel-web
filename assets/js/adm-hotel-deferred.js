...
const VERSION = '20260912-alojamentos-compras1';
...
function loadAlojamentosModules() {
  ...
  alojamentosPromise = new Promise((resolve) => schedule(async () => {
    await Promise.allSettled([
      ...
      importSafe('./adm-hotel-alojamentos-pagamentos.js?v=20260912-alojamentos-compras1'),
      importSafe('./adm-hotel-alojamentos-compras.js?v=20260912-alojamentos-compras1'),
