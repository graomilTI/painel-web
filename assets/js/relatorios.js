(function () {
  ...
  async function uploadAndRegister({ file, item, bar, status, entry }, opts) {
    ...
    if (!['hoteis', 'pontos_embarque', 'colaboradores_operacional', 'auditorias_operacional', 'patrimonios'].includes(detected.tipo)) {
      ...
      else if (historicoDiarioResumo?.periodo_inicio) period = { inicio: historicoDiarioResumo.periodo_inicio, fim: historicoDiarioResumo.periodo_fim, totalDatas: historicoDiarioResumo.total_datas || null };
    ...
    const statusRegistroMap = {
      hospedagem_historico: 'Registrando upload do histórico de hospedagem...',
