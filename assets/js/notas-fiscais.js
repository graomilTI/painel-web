...
initProtectedPage('Notas Fiscais', (content) => {
  content.innerHTML = `
    <style>
      .nf-wrap{display:grid;gap:18px}.nf-hero{border:1px solid rgba(148,163,184,.18);border-radius:24px;padding:22px;background:linear-gradient(135deg,rgba(15,23,42,.96),rgba(22,101,52,.22));box-shadow:0 20px 50px rgba(2,6,23,.22)}.nf-hero h2{margin:0 0 6px;color:#f8fafc;font-size:28px}.nf-hero p{margin:0;color:#94a3b8}.nf-card{border:1px solid rgba(148,163,184,.16);border-radius:22px;background:rgba(15,23,42,.82);padding:18px}.nf-filter{display:grid;grid-template-columns:repeat(3,minmax(160px,1fr));gap:12px;align-items:end}.nf-field{display:grid;gap:6px}.nf-field label{font-size:12px;color:#94a3b8;text-transform:uppercase;letter-spacing:.06em}.nf-field input{border:1px solid rgba(148,163,184,.22);border-radius:14px;background:#0f172a;color:#e5e7eb;padding:10px 12px;color-scheme:dark}.nf-kpis{display:grid;grid-template-columns:repeat(3,minmax(150px,1fr));gap:12px}.nf-kpi{border:1px solid rgba(148,163,184,.14);border-radius:18px;padding:14px;background:rgba(2,6,23,.36)}.nf-kpi span{display:block;color:#94a3b8;font-size:11px;text-transform:uppercase;letter-spacing:.06em}.nf-kpi strong{display:block;margin-top:6px;color:#f8fafc;font-size:20px}.nf-table-wrap{overflow:auto;border-radius:18px;border:1px solid rgba(148,163,184,.14)}.nf-table{width:100%;border-collapse:collapse;min-width:760px}.nf-table th,.nf-table td{padding:12px;border-bottom:1px solid rgba(148,163,184,.12);text-align:left;color:#e5e7eb}.nf-table th{background:rgba(15,23,42,.96);color:#94a3b8;font-size:12px;text-transform:uppercase;letter-spacing:.06em}.nf-empty{text-align:center;color:#94a3b8;padding:24px!important}@media(max-width:760px){.nf-filter,.nf-kpis{grid-template-columns:1fr}}
    </style>
