...
function renderSolicitacoes(){
  ...
  if(!lista.length){body.innerHTML=`<tr><td colspan="4" class="epi-empty">${state.solicitacoes.length?'Nenhuma solicitação nesta aba.':'Nenhuma solicitação de compra. Clique em <b>+ Adicionar</b> para criar.'}</td></tr>`;return;}
