...
function render(el){
  ...
  const pronto=escRows.filter(r=>r.status==='PRONTO PARA BTG'), prontoUrl=pronto.filter(r=>urlBtg(r)), pend=list.filter(r=>status(r)!=='OK').length;
