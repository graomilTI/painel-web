...
@media(max-width:960px){.cmp-add-box{grid-template-columns:1fr 1fr}}
@media(max-width:760px){
  .cmp-grid,.cmp-add-box{grid-template-columns:1fr}
...
initProtectedPage('Compras', async (content, userContext)=>{
  ...
  <section class="card mt-16"><div class="section-head" style="margin-bottom:12px"><div><h3 style="margin:0">Pendentes e histórico</h3></div><button class="btn btn-secondary" id="cmpRefresh" type="button">↻ Atualizar</button></div><div class="cmp-table-wrap"><table class="cmp-table"><thead><tr><th>Data</th><th>Tipo</th><th>Itens</th><th>Status</th><th>Motivo</th></tr></thead><tbody id="cmpMinhasBody"></tbody></table></div></section>`;
