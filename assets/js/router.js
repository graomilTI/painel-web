...
const SOFT_NAV_PAGES = new Map([
  ...
  ['adm-conferencia', { title: 'ADM Conferência', module: () => import('./adm-conferencia.js?v=20260909-alojamento-prioridade1'), extraModules: [() => import('./adm-conferencia-entry.js?v=20260909-disponivel-roster1'), () => import('./adm-conferencia-actions-clean.js'), () => import('./adm-conferencia-sem-os.js')] }],
  ...
  ['dashboard-socio', { title: 'Panorama da Empresa', module: () => import('./dashboard-socio.js?v=20260909-4') }],
  ...
  ['programacao', { title: 'Programação', module: () => import('./programacao.js'), extraModules: [
    ...
    () => import('./programacao-gestor-fluxo-avancado.js?v=20260909-auto-refresh-os-removida'),
