...
const SOFT_NAV_PAGES = new Map([
  ...
  ['logistica', { title: 'Logística', module: () => import('./logistica.js?v=20260924-locais-grm3'), extraModules: [() => import('./logistica-abertura-os-correcao.js?v=20260924-locais-grm3'), () => import('./logistica-clientes-filiais-pagadoras.js?v=20260903-clientes-filiais-master1')] }],
