...
const SOFT_NAV_PAGES = new Map([
  ...
  ['adm-conferencia', {
    title: 'ADM Conferência',
    module: () => import('./adm-conferencia.js?v=20260802-cleanlayout1'),
    extraModules: [
      () => import('./adm-conferencia-entry.js?v=20260802-cleanlayout1'),
      () => import('./adm-conferencia-actions-clean.js?v=20260802-cleanlayout1'),
    ],
  }],
  ...
  ['logistica', { title: 'Logística', module: () => import('./logistica.js'), extraModules: [() => import('./logistica-abertura-os-correcao.js')] }],
  ...
  ['programacao', { title: 'Programação', module: () => import('./programacao.js'), extraModules: [
    ...
    () => import('./programacao-gestor-fluxo-avancado.js'),
