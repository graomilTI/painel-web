...
const SOFT_NAV_PAGES = new Map([
  ...
  ['adm-conferencia', { title: 'ADM Conferência', module: () => import('./adm-conferencia.js?v=20260911-abas-sublinhado1'), extraModules: [() => import('./adm-conferencia-entry.js?v=20260910-rpc-colaboradores1'), () => import('./adm-conferencia-actions-clean.js'), () => import('./adm-conferencia-sem-os.js?v=20260912-espelha-status-data2')] }],
  ...
  ['hospedagem', { title: 'Hospedagem', module: () => import('./hospedagem.js?v=20260912-hosp-workspace1') }],
  ...
  ['programacao', { title: 'Programação', module: () => import('./programacao.js?v=20260915-despesa-compartilhada1'), extraModules: [
    ...
    () => import('./programacao-gestor-fluxo-avancado.js?v=20260915-despesa-compartilhada1'),
    () => import('./programacao-lista-drawer-fixo.js'),
    () => import('./programacao-lista-drawer-ux-hotfix.js'),
    () => import('./programacao-pdf-tipo-fix.js?v=20260915-despesa-compartilhada1'),
