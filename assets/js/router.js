...
const SOFT_NAV_PAGES = new Map([
  ...
  ['programacao', { title: 'Programação', module: () => import('./programacao.js?v=20260915-reaproveitada-card1'), extraModules: [
    ...
    () => import('./programacao-gestor-fluxo-avancado.js?v=20260915-reaproveitada-card1'),
    () => import('./programacao-lista-drawer-fixo.js'),
    () => import('./programacao-lista-drawer-ux-hotfix.js'),
    () => import('./programacao-pdf-tipo-fix.js?v=20260915-reaproveitada-card1'),
