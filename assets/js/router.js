...
const SOFT_NAV_PAGES = new Map([
  ...
  ['adm-conferencia', { title: 'ADM Conferência', module: () => import('./adm-conferencia.js?v=20260910-almoco-cargo-fix1'), extraModules: [() => import('./adm-conferencia-entry.js?v=20260910-rpc-colaboradores1'), () => import('./adm-conferencia-actions-clean.js'), () => import('./adm-conferencia-sem-os.js')] }],
