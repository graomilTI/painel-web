...
body.mobile-gestor-mode .gm-model-tabs{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:9px 0;width:100%}
body.mobile-gestor-mode .gm-model-tab{min-height:40px;border:1px solid var(--line-2);background:var(--bg-card);color:var(--text);border-radius:12px;font:inherit;padding:7px;font-size:13px}.gm-model-tab.active{background:var(--green-soft)!important;border-color:var(--green-2)!important}
/* compras */
body.mobile-gestor-mode .cmp-page-tabs{display:grid!important;grid-template-columns:1fr 1fr!important;gap:10px!important;width:min(100%,320px)!important;margin-left:auto!important}
body.mobile-gestor-mode .cmp-page-tab{width:100%!important;min-height:52px!important;margin:0!important;border-radius:12px!important;background:var(--bg-card)!important;border-color:var(--line-2)!important;color:var(--text)!important;font-size:15px!important}
body.mobile-gestor-mode .cmp-page-tab.active{background:var(--green-soft)!important;border-color:var(--green-2)!important}
...
body.mobile-gestor-mode .cmp-request-card .cmp-tabs{display:grid!important;grid-template-columns:1fr 1fr!important}.cmp-request-card .cmp-tab{border-radius:12px!important;background:var(--bg-soft)!important;color:var(--text)!important}
