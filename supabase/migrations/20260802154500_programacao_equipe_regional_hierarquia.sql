-- Alinha a proteção do banco ao cadastro regional usado pela Programação.
--
-- Cadastros novos podem possuir a supervisão completa, por exemplo:
--   MATO GROSSO MT2 - Sul
--
-- Cadastros legados podem possuir somente a base:
--   coordenacao = MATO GROSSO MT2
--   supervisao  = MATO GROSSO MT2 (ou vazio)
--
-- Uma supervisão explícita diferente, como MT2 - Leste, continua bloqueada.
...
-- O trigger já existe na implantação anterior. Este bloco garante sua presença
-- também em ambientes que aplicarem diretamente esta migration.
