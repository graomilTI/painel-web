...
async function upsertData(data) {
  ...
  // anterior. Mesmo padrão já corrigido em grmserver-patrimonios-api.js e em
  // grmserver-contas-receber-api.js: insert simples + limpeza do lote
  // anterior por created_at (tabela só serve de estágio do lote mais
  // recente).
